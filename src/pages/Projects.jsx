...
const ProjectsPage = () => {
  ...
  const uiProjects = projects.filter(p => p.category === 'UI Projects');
  const baProjects = projects.filter(p => p.category === 'BA Projects');
  ...
  return (
    <main className="pt-4">
      <section className="px-4 py-12">
        ...
        >
          ...
          <Typography variant="p" className="text-muted-foreground text-sm max-w-xl leading-relaxed">
            A collection of my work spanning web development, business analysis, and data-driven projects.
            Each project represents a unique challenge and a step forward in my journey.
          </Typography>
        </motion.div>
      </section>
      ...
      <SectionDivider />
      <ProjectSection title="UI Projects" data={uiProjects} subtitle="Interfaces & Pixels" />

      <SectionDivider />
      <ProjectSection title="BA Projects" data={baProjects} subtitle="Analysis & Insights" />
