    ...
    >
      ...
      */}
      <img
        src={src}
        alt={alt}
        className="absolute inset-0 w-full h-full object-cover scale-[1.15] translate-y-2"
      />
      ...
      <video
        ...
        playsInline
        preload="auto"
        className={`absolute inset-0 w-full h-full object-cover scale-[1.15] translate-y-2 transition-opacity duration-300 ${
