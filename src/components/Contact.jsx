...
export default function Contact() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("aniketbajpai230@gmail.com");
    setCopied(true);
    ...
    <section className="flex justify-center p-4">
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-[0.15rem] bg-black/80 p-[0.15rem] rounded-md">
          ...
          <TactileButton
            onClick={() => window.location.href = 'mailto:aniketbajpai230@gmail.com'}
        ...
        <div className="mt-4 flex items-center justify-between px-2 opacity-40">
          ...
          <span className="text-[0.8rem] font-light uppercase">AB</span>
        </div>
