...
const ScreenDisplay = () => {
  // Dynamically load all images from the assets/UI folder using Vite
  const imageModules = import.meta.glob('../assets/UI/*.png', { eager: true, query: '?url', import: 'default' });
  const uiImages = Object.values(imageModules);
