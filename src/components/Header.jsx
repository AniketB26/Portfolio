...
export default function Header({ isDark, toggleTheme }) {
  ...
  const getPageContext = () => {
    ...
    if (path === '/') return { title: 'Aniket Bajpai', subtitle: 'Full Stack Developer', root: true };
    ...
    if (path === '/practice') return { title: 'Practice Platforms', subtitle: 'Coding Profiles', root: false };
    return { title: 'Portfolio', subtitle: 'Aniket', root: true };
  };
