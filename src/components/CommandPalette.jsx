  ...
  const commandSections = [
    {
      ...
      items: [
        ...
        { id: 'nav-practice', label: 'Practice Platforms', icon: File01Icon, shortcut: 'C', action: () => navigate('/practice') },
      ]
    },
    {
      group: "Preferences",
    ...
    },
    {
      group: "Projects",
      items: [
        { id: 'proj-ecosort', label: 'EcoSort', icon: Globe02Icon, action: () => navigate('/project/ecosort') },
        { id: 'proj-dataquery', label: 'DataQuery Pro', icon: Globe02Icon, action: () => navigate('/project/dataquery-pro') },
        { id: 'proj-funnel', label: 'Funnel & Churn Analysis', icon: Globe02Icon, action: () => navigate('/project/funnel-churn-analysis') },
      ]
    },
    {
      group: "Social Links",
