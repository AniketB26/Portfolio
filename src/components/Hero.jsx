...
import { Location01Icon, Download01Icon, ViewIcon, CheckmarkBadge01Icon } from 'hugeicons-react';
    ...
    <section className="relative w-full">
      ...
      <div className="absolute top-40 right-4 z-20 flex items-center gap-4 sm:gap-6">
        <div className="flex items-center gap-2 opacity-60 hover:opacity-100 transition-opacity">
          ...
          <Typography variant="small" className="font-medium tracking-wide text-foreground">Phagwara, Punjab, India</Typography>
        </div>
      </div>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-8">
              <Button
                ...
                onClick={() => {
                  ...
                  link.download = 'Aniket_Bajpai_CV.pdf';
